...
function GliaChat({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `flex flex-col h-full ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { ref: feedRef, className: "flex-1 overflow-y-auto p-4 space-y-4", children: [
      messages.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-center text-sm text-gray-400 mt-[40%]", children: welcomeMessage }),
      messages.map((msg) => /* @__PURE__ */ jsx("div", { className: `flex ${msg.role === "user" ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsx("div", { className: `max-w-[80%] rounded-2xl px-4 py-2.5 text-sm ${msg.role === "user" ? "bg-blue-600 text-white rounded-br-sm" : "bg-gray-100 text-gray-800 rounded-bl-sm"}`, children: /* @__PURE__ */ jsx("div", { className: "whitespace-pre-wrap", children: msg.content }) }) }, msg.id)),
      isStreaming && streamContent && /* @__PURE__ */ jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsx("div", { className: "max-w-[80%] rounded-2xl rounded-bl-sm px-4 py-2.5 text-sm bg-gray-100", children: /* @__PURE__ */ jsx("div", { className: "whitespace-pre-wrap", children: streamContent }) }) }),
      isStreaming && !streamContent && /* @__PURE__ */ jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsx("div", { className: "px-4 py-2.5 text-sm text-gray-400", children: "Pensando..." }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "border-t p-3", children: [
      suggestions.length > 0 && !isStreaming && /* @__PURE__ */ jsx("div", { className: "flex gap-2 mb-2 overflow-x-auto pb-1", children: suggestions.map((s, i) => /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-2 border rounded-xl p-2 bg-gray-50", children: [
        /* @__PURE__ */ jsx(
          "textarea",
          {
            value: input,
...
export { GliaChat, GliaConversationList, GliaCopilot, GliaFileBrowser, GliaSkillEditor, useGlia, useGliaAgents, useGliaConversations, useGliaFiles, useGliaSkills };
