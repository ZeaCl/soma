...
function GliaChat({
  ...
  const [thinkingOpenIds, setThinkingOpenIds] = useState({});
  const toggleMsgThinking = useCallback((id) => {
    setThinkingOpenIds((prev) => ({ ...prev, [id]: !prev[id] }));
  }, []);
  const defaultMessage = (msg) => {
    const thinkingOpen2 = !!thinkingOpenIds[msg.id];
    return /* @__PURE__ */ jsxs("div", { className: "glia-msg", style: css({ display: "flex", flexDirection: "column", alignItems: msg.role === "user" ? "flex-end" : "flex-start", gap: 4 }), children: [
      msg.thinking && /* @__PURE__ */ jsxs("div", { className: "glia-thinking-persisted", style: css({ maxWidth: "85%", borderRadius: c.radius, overflow: "hidden" }), children: [
        /* @__PURE__ */ jsxs("button", { onClick: () => toggleMsgThinking(msg.id), style: css({
          display: "flex",
          alignItems: "center",
          gap: 6,
          width: "100%",
          ...
          /* @__PURE__ */ jsx("span", { style: css({ fontSize: 10 }), children: thinkingOpen2 ? "\u25BC" : "\u25B6" }),
          /* @__PURE__ */ jsx("span", { style: css({ padding: "0px 5px", borderRadius: 3, background: c.thinkingBorder, fontSize: 9 }), children: "thinking" })
        ] }),
        thinkingOpen2 && /* @__PURE__ */ jsx("div", { style: css({
          padding: "6px 10px",
          background: c.thinkingBg,
      ...
      /* @__PURE__ */ jsx("div", { className: "glia-bubble", style: css({
        maxWidth: "85%",
        padding: "10px 14px",
      ...
      }), children: /* @__PURE__ */ jsx("div", { className: "glia-md", dangerouslySetInnerHTML: { __html: renderMarkdown(msg.content) } }) })
    ] }, msg.id);
  };
...
function GliaFileBrowser({ files, loading, onSelect, readFile }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S.mu, fontSize: 13, fontFamily: "system-ui, sans-serif" }, children: "Cargando archivos..." });
  }
  if (files.length === 0) {
    return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S.mu, fontSize: 13, fontFamily: "system-ui, sans-serif" }, children: "No hay archivos." });
  }
  ...
  if (viewingFile) {
    return /* @__PURE__ */ jsxs("div", { style: { height: "100%", display: "flex", flexDirection: "column", fontFamily: "system-ui, sans-serif" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", borderBottom: `1px solid ${S.bc}`, background: S.row }, children: [
        /* @__PURE__ */ jsxs("span", { style: { fontSize: 12, color: S.tx }, children: [
          "\u{1F4C4} ",
          viewingFile.name
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: closeViewer, style: { background: "none", border: "none", color: S.mu, cursor: "pointer", fontSize: 16 }, children: "\u2190 Volver" })
      ] }),
      /* @__PURE__ */ jsx("div", { style: { flex: 1, overflow: "auto", padding: 16, background: S.bg, color: S.tx, fontSize: 13, lineHeight: 1.6, whiteSpace: "pre-wrap", wordBreak: "break-word" }, children: viewingFile.loading ? "Cargando..." : viewingFile.content || "(archivo vac\xEDo)" })
    ] });
  }
  return /* @__PURE__ */ jsx("div", { style: { fontFamily: "system-ui, sans-serif", fontSize: 13 }, children: /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { borderBottom: `1px solid ${S.bc}` }, children: [
      /* @__PURE__ */ jsx("th", { style: { padding: "6px 12px", textAlign: "left", color: S.mu, fontWeight: 500, width: 30 } }),
      /* @__PURE__ */ jsx("th", { style: { padding: "6px 12px", textAlign: "left", color: S.mu, fontWeight: 500 }, children: "Nombre" }),
      /* @__PURE__ */ jsx("th", { style: { padding: "6px 12px", textAlign: "left", color: S.mu, fontWeight: 500, width: 70 }, children: "Tipo" }),
      /* @__PURE__ */ jsx("th", { style: { padding: "6px 12px", textAlign: "right", color: S.mu, fontWeight: 500, width: 80 }, children: "Tama\xF1o" })
    ] }) }),
    /* @__PURE__ */ jsx("tbody", { children: sorted.map((f, i) => /* @__PURE__ */ jsxs(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("td", { style: { padding: "6px 12px", textAlign: "center" }, children: fileIcon(f) }),
          /* @__PURE__ */ jsx("td", { style: { padding: "6px 12px", color: f.type === "dir" ? S.pr : S.tx }, children: f.name }),
          /* @__PURE__ */ jsx("td", { style: { padding: "6px 12px", color: S.mu }, children: f.type === "dir" ? "Directorio" : f.ext || "archivo" }),
          /* @__PURE__ */ jsx("td", { style: { padding: "6px 12px", textAlign: "right", color: S.mu }, children: f.type === "file" ? formatSize(f.size) : "\u2014" })
        ]
      },
      i
    )) })
...
function GliaFileViewer({ content, fileName, loading, error, onClose }) {
  if (loading) {
    return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: "#8b949e", fontSize: 13, fontFamily: "system-ui, sans-serif" }, children: "Cargando contenido..." });
  }
  if (error) {
    return /* @__PURE__ */ jsxs("div", { style: { padding: 16, color: "#f85149", fontSize: 13, fontFamily: "system-ui, sans-serif" }, children: [
      "Error: ",
      error
    ] });
  }
  if (content === null) {
    return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: "#8b949e", fontSize: 13, fontFamily: "system-ui, sans-serif" }, children: "Seleccion\xE1 un archivo para ver su contenido." });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { style: { height: "100%", display: "flex", flexDirection: "column", fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxs("span", { style: { fontSize: 12, color: "#8b949e" }, children: [
        "\u{1F4C4} ",
        fileName || "archivo",
        ext && /* @__PURE__ */ jsxs("span", { style: { marginLeft: 8, color: "#484f58" }, children: [
          ".",
          ext
        ] })
      ] }),
...
function AgentSkillPanel({ agentId, token, somaUrl = "http://soma.zea.localhost", onRefresh }) {
  ...
  if (loading) return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S2.mu, fontSize: 13 }, children: "Loading skills..." });
  if (error) return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S2.red, fontSize: 13 }, children: error });
  return /* @__PURE__ */ jsxs("div", { style: { padding: 16, fontFamily: "system-ui, sans-serif", fontSize: 13, height: "100%", overflow: "auto" }, children: [
    /* @__PURE__ */ jsxs("h3", { style: { fontSize: 14, fontWeight: 600, color: S2.tx, marginBottom: 8 }, children: [
      "\u{1F4CB} Skills asignadas (",
      assignedSkills.length,
      ")"
    ] }),
    assignedSkills.length === 0 && /* @__PURE__ */ jsx("div", { style: { color: S2.mu, marginBottom: 16 }, children: "No hay skills asignadas a este agente." }),
    assignedSkills.map((s) => /* @__PURE__ */ jsxs("div", { style: { padding: "8px 12px", marginBottom: 6, background: S2.row, borderRadius: 6, border: `1px solid ${S2.bc}` }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { cursor: "pointer", flex: 1 }, onClick: () => viewContent(s.name), children: [
          /* @__PURE__ */ jsx("div", { style: { color: S2.tx, fontWeight: 500 }, children: s.name }),
          /* @__PURE__ */ jsx("div", { style: { color: S2.ha, fontSize: 11, marginTop: 2 }, children: s.description?.slice(0, 100) })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => unassign(s.name), style: {
          background: S2.red,
          color: "#fff",
          border: "none",
          borderRadius: 4,
      ...
      viewingSkill === s.name && /* @__PURE__ */ jsx("div", { style: { marginTop: 8, padding: 8, background: S2.bg, borderRadius: 4, fontSize: 10, color: S2.tx, maxHeight: 150, overflow: "auto", whiteSpace: "pre-wrap", fontFamily: "monospace" }, children: skillContent || "(sin contenido)" })
    ] }, s.name)),
    /* @__PURE__ */ jsxs("h3", { style: { fontSize: 14, fontWeight: 600, color: S2.tx, marginBottom: 8, marginTop: 20 }, children: [
      "\u{1F4E6} Skills disponibles (",
      availableSkills.length,
      ")"
    ] }),
    availableSkills.length === 0 && /* @__PURE__ */ jsx("div", { style: { color: S2.mu }, children: "Todas las skills est\xE1n asignadas." }),
    availableSkills.map((s) => /* @__PURE__ */ jsxs("div", { style: { padding: "8px 12px", marginBottom: 6, background: S2.row, borderRadius: 6, border: `1px dashed ${S2.bc}`, opacity: 0.7 }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [
        /* @__PURE__ */ jsxs("div", { style: { cursor: "pointer", flex: 1 }, onClick: () => viewContent(s.name), children: [
          /* @__PURE__ */ jsx("div", { style: { color: S2.tx, fontWeight: 500 }, children: s.name }),
          /* @__PURE__ */ jsx("div", { style: { color: S2.ha, fontSize: 11, marginTop: 2 }, children: s.description?.slice(0, 100) })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: () => assign(s.name), style: {
          background: S2.green,
          color: "#fff",
          border: "none",
          borderRadius: 4,
...
function SkillManager({ token, somaUrl = "http://soma.zea.localhost", onSkillAssigned }) {
  ...
  if (loading) return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S3.mu, fontSize: 12 }, children: "Loading skills..." });
  if (error) return /* @__PURE__ */ jsx("div", { style: { padding: 16, color: S3.red, fontSize: 12 }, children: error });
  return /* @__PURE__ */ jsxs("div", { style: { fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 16px", borderBottom: `1px solid ${S3.bc}` }, children: [
      /* @__PURE__ */ jsxs("span", { style: { fontSize: 11, fontWeight: 600, color: S3.mu, textTransform: "uppercase" }, children: [
        "Skills (",
        skills.length,
        ")"
      ] }),
      /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 4 }, children: /* @__PURE__ */ jsx("button", { onClick: () => setShowAdd(!showAdd), style: { background: S3.green, color: "#fff", border: "none", borderRadius: 4, padding: "2px 8px", cursor: "pointer", fontSize: 10, fontFamily: "inherit" }, children: "+ Add" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { style: { padding: "4px 16px" }, children: /* @__PURE__ */ jsx("input", { value: search, onChange: (e) => setSearch(e.target.value), placeholder: "\u{1F50D} Filter skills...", style: { width: "100%", background: S3.bg, border: `1px solid ${S3.bc}`, borderRadius: 4, color: S3.tx, padding: "3px 8px", fontSize: 11, fontFamily: "inherit", outline: "none", boxSizing: "border-box" } }) }),
    showAdd && /* @__PURE__ */ jsxs("div", { style: { padding: "0 16px 8px", display: "flex", flexDirection: "column", gap: 6 }, children: [
      /* @__PURE__ */ jsx("input", { value: newName, onChange: (e) => setNewName(e.target.value), placeholder: "skill-name", style: inputStyle }),
      /* @__PURE__ */ jsx("textarea", { value: newContent, onChange: (e) => setNewContent(e.target.value), placeholder: "SKILL.md content...", rows: 3, style: { ...inputStyle, resize: "vertical", minHeight: 60 } }),
      /* @__PURE__ */ jsx("button", { onClick: addSkill, style: { background: S3.green, color: "#fff", border: "none", borderRadius: 4, padding: "4px 12px", cursor: "pointer", fontSize: 11, fontFamily: "inherit" }, children: "Create Skill" })
    ] }),
    filtered.map((s) => /* @__PURE__ */ jsxs("div", { style: { padding: "6px 16px", borderBottom: `1px solid ${S3.bc}` }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }, children: [
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, cursor: "pointer" }, onClick: () => viewContent(s.name), children: [
          /* @__PURE__ */ jsx("div", { style: { fontSize: 12, color: S3.tx, fontWeight: 500 }, children: s.name }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: 10, color: S3.ha, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", marginTop: 1 }, children: s.description?.slice(0, 80) }),
          (s.agents || []).length > 0 && /* @__PURE__ */ jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 3, marginTop: 3 }, children: (s.agents || []).map((aid) => /* @__PURE__ */ jsxs("span", { style: { fontSize: 9, background: `${S3.pr}20`, color: S3.pr, padding: "0px 5px", borderRadius: 3, display: "inline-flex", alignItems: "center", gap: 2 }, children: [
            getAgentName(aid),
            /* @__PURE__ */ jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 4, alignItems: "center", flexShrink: 0 }, children: [
          s.custom && /* @__PURE__ */ jsx("span", { style: { fontSize: 8, background: "#3fb95020", color: "#3fb950", padding: "1px 4px", borderRadius: 3 }, children: "custom" }),
          s.builtin && /* @__PURE__ */ jsx("span", { style: { fontSize: 8, background: `${S3.pr}20`, color: S3.pr, padding: "1px 4px", borderRadius: 3 }, children: "builtin" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              value: "",
              ...
              children: [
                ...
                agents.filter((a) => !(s.agents || []).includes(a.id)).map((a) => /* @__PURE__ */ jsx("option", { value: a.id, children: (a.name || a.email || "").slice(0, 14) }, a.id))
              ]
            }
          ),
          s.custom && /* @__PURE__ */ jsx("button", { onClick: () => deleteSkill(s.name), style: { background: "none", border: "none", color: S3.red, cursor: "pointer", fontSize: 10, padding: 0 }, children: "\u{1F5D1}" })
        ] })
      ] }),
      viewingSkill === s.name && /* @__PURE__ */ jsx("div", { style: { marginTop: 6, padding: 8, background: S3.bg, borderRadius: 4, border: `1px solid ${S3.bc}`, fontSize: 10, color: S3.tx, maxHeight: 200, overflow: "auto", whiteSpace: "pre-wrap", fontFamily: "monospace" }, children: skillContent || "(sin contenido)" })
    ] }, s.name))
  ] });
}
var inputStyle = {
