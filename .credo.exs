    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Readability.SingleFunctionToMatchPipe, []},
          ...
          # ── Refactor ──
          {Credo.Check.Refactor.ABCSize, [max_abc_size: 30]},
          ...
          # ── Custom: file size ──
          {Credo.Check.Refactor.ModuleDependencies, [max_dependencies: 8]},
        ]
      }
    }
  ]
